...
<head>
    ...
    <div class="logo">
        <img src="{{ asset('images/skywings.jpg') }}" alt="Sky Wings Logo" width="200" height="30">
        <span>Sky Wings</span>
    </div>
</head>
<body>
    {{-- If you actually use a partial, keep it. Otherwise you can remove this include. --}}
        ...
        <div class="container">
            <div class="header-top">
                ...
                <ul class="nav-links">
                    ...
                    {{-- Map page removed. If you keep a commented line, use Blade comment so it doesn't execute. --}}
                    {{-- <li><a href="{{ route('map') }}">Map</a></li> --}}

                    <li><a href="{{ route('contact') }}">Contact</a></li>

                    {{-- Show Admin only when logged in (you can add is_admin check later) --}}
                    @auth
