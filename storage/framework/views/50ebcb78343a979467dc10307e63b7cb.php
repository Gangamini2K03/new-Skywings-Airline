...
<section id="about" class="about">
    <div class="container">
        ...
        <div class="about-content">
            <div class="about-img" style="background: url('<?php echo e(asset('images/about.jpg')); ?>') center/cover; height:400px; border-radius:10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15); flex: 1;"></div>
