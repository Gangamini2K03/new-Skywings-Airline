...
<section id="hotels" class="hotel-reservation">
    <div class="container">
        ...
        <div class="booking-container">
            <form method="POST" action="<?php echo e(route('hotels.store')); ?>" class="booking-form">
                <?php echo csrf_field(); ?>
        ...
        <div class="services-grid" style="margin-top: 50px;">
            <div class="service-card">
                <div class="service-img" style="background-image: url('<?php echo e(asset('images/grand.jpg')); ?>'); background-size: cover;"></div>
            ...
            <div class="service-card">
                <div class="service-img" style="background-image: url('<?php echo e(asset('images/skyview.jpg')); ?>'); background-size: cover;"></div>
                <div class="service-content">
            ...
            <div class="service-card">
                <div class="service-img" style="background-image: url('<?php echo e(asset('images/riverside.jpg')); ?>'); background-size: cover;"></div>
                <div class="service-content">
